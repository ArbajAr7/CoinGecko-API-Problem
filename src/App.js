...
const App = () => {
  ...
  const onChange = (e) => {
    ...
    const filteredPosts = posts.filter(post => 
      post.name.toLowerCase().includes(query) || post.symbol.toLowerCase().includes(query)
    );
  ...
  return (
    <div className="container">
      <SearchBar onSortByMktCap={handleSortByMktCap} onSortByPercentage={handleSortByPercentage} onChange= {onChange}/> 
